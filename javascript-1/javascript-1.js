...
//CODE HERE
   let phone1 = new Phone('moto', 'x', 256, 'black', false);
  
   let phone2 = new Phone('moto', 'y', 512, 'silver', false)
  
   let phone3 = new Phone('moto', 'z', 2058, 'gold', false)
