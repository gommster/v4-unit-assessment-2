...
//CODE HERE
let orderTotal = blueProducts.reduce((total, product) => total += product.price, 0)
//////////////////////////////////PROBLEMS 5-8//////////////////////////////////
/*
...
//CODE HERE
let ellensInfo = Object.assign({}, {...helensInfo, name: 'Ellen', email: 'ellen@email.com'})
////////////////////PROBLEM 7////////////////////
/* 
...
let person = {
  name: 'John',
  age: 30,
  jobs: ['defend humans', 'kill aliens', 'lead'],
  ...
  kids: [{name: 'joedat', age: 30}, {name: 'tyler', age: 25}]
}
//////////////////////////////////PROBLEMS 13-14//////////////////////////////////
/*
